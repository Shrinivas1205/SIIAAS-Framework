...
public class TC_01_026 extends BaseTest {
	...
	@Test(retryAnalyzer = RetryAnalyzer.class,description = "TC-01-026 : Verify login with uppercase or mixed-case email")
	public void verifyLoginWithUppercaseOrMixedCaseEmail() {
		...
		loginPage.enterEmail("ADMIN@APRIL.COM");
		 ...
		 loginPage.attachStepScreenshot("Uppercase_Email_Entered");
