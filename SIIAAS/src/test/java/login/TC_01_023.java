...
public class TC_01_023 extends BaseTest {
    ...
    @Test(description = "TC-01-023 : Verify already logged-in user accessing login page is redirected")
    public void verifyLoggedInUserRedirectedFromLoginPage() {
        ...
        ScreenshotUtil.captureAndAttachScreenshot(page,test,"Navigated_Back_To_Login_Page");
        ...
        ScreenshotUtil.captureAndAttachScreenshot(page,test,"Redirected_To_Projects_Page");
