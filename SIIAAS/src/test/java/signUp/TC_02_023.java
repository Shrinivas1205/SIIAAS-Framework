...
public class TC_02_023 extends BaseTest {
	...
	@Test(retryAnalyzer = RetryAnalyzer.class,description = "TC-02-023 : Verify signup with password below minimum length")
	public void verifySignupWithShortPassword() {
		...
		signupPage.enterEmail(ConfigReader.getProperty("tc02023.email"));

		signupPage.enterPassword(ConfigReader.getProperty("tc02023.password"));

		signupPage.enterConfirmPassword(ConfigReader.getProperty("tc02023.confirmPassword"));
